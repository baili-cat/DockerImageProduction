...
docker buildx build -t $REPO --platform=linux/$ARCH -o type=docker --build-arg ARCH=$ARCH --build-arg ROCKETMQ_DOCKERTAG=$ROCKETMQ_DOCKERTAG  -f $DOCKERFILE .
