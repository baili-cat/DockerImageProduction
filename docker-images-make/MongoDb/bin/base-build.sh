...
docker buildx build -t $REPO --platform=linux/$ARCH -o type=docker --build-arg ARCH=$ARCH --build-arg MONGODBDOCKERTAG=$MONGODBDOCKERTAG --build-arg MONGODBEXPORTINITSQL=$MONGODBEXPORTINITSQL -f $DOCKERFILE .
